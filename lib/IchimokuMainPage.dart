...
import 'package:bourse_pardaz/class/IchimokuItems.dart';

import 'package:persian_number_utility/persian_number_utility.dart';
//import 'package:shared_preferences/shared_preferences.dart';

Future<List<IchimokuItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/indicators/daily/ichimoku.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}

Future<List<IchimokuItems>> fetchWeeklyItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/indicators/weekly/ichimoku.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}

Future<List<IchimokuItems>> fetchMonthlyItems(Client client) async {
  String url =
      'https://bourspardaz.s3.ir-tbz-sh1.arvanstorage.com/indicators/monthly/ichimoku.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}

List<IchimokuItems> parseItems(String response) {
  final parsed = json.decode(response).cast<Map<String, dynamic>>();

  return parsed
      .map<IchimokuItems>((json) => IchimokuItems.fromJson(json))
      .toList();
}

class IchimokuMainPage extends StatefulWidget {
  final String title;
  ...
  @override
  _IchimokuMainPageState createState() => _IchimokuMainPageState();
}

class _IchimokuMainPageState extends State<IchimokuMainPage> {
...
class GenerateCard extends StatelessWidget {
  final List<IchimokuItems> items;
                      ...
                      children: [
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].tSen, NumStrLanguage.Farsi),
                          ),
                        ...
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].kSen, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                        ...
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].high, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.center,
                          style: TextStyle(fontSize: 11),
                    ...
                    child: Column(
                      children: [
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].spanA, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.center,
                          style: TextStyle(fontSize: 11),
                        ...
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].spanB, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                        ...
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].low, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.center,
                          style: TextStyle(fontSize: 11),
                    ...
                    child: Column(
                      children: [
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].chikou, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.center,
                          style: TextStyle(fontSize: 11),
                        ...
                        Text(
                          ...
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              backgroundColor: Color(0xffeaddd4), fontSize: 10),
                        ),
                        Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].close, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.center,
                          style: TextStyle(fontSize: 11),
