...
import 'package:bourse_pardaz/class/BollingerItems.dart';
import 'package:persian_number_utility/persian_number_utility.dart';
//import 'package:shared_preferences/shared_preferences.dart';

Future<List<BollingerItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/indicators/daily/bollinger.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}

Future<List<BollingerItems>> fetchWeeklyItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/indicators/weekly/bollinger.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}

Future<List<BollingerItems>> fetchMonthlyItems(Client client) async {
  String url =
      'https://bourspardaz.s3.ir-tbz-sh1.arvanstorage.com/indicators/monthly/bollinger.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}

List<BollingerItems> parseItems(String response) {
  final parsed = json.decode(response).cast<Map<String, dynamic>>();

  return parsed
      .map<BollingerItems>((json) => BollingerItems.fromJson(json))
      .toList();
}

class BollingerMainPage extends StatefulWidget {
  final String title;
  ...
  @override
  _BollingerMainPageState createState() => _BollingerMainPageState();
}

class _BollingerMainPageState extends State<BollingerMainPage> {
...
class GenerateCard extends StatelessWidget {
  final List<BollingerItems> items;
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].uBand, NumStrLanguage.Farsi),
                          ),
                      ...
                      Container(
                        ...
                        child: Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].lBand, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          style: TextStyle(fontSize: 11),
                          textAlign: TextAlign.center,
                  ...
                  Container(
                    ...
                    child: Text(
                      NumberUtility.seRagham(
                        NumberUtility.changeDigit(
                            items[index].mBand, NumStrLanguage.Farsi),
                      ),
                      textDirection: TextDirection.ltr,
                      style: TextStyle(fontSize: 11),
                      textAlign: TextAlign.center,
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          NumberUtility.seRagham(
                            NumberUtility.changeDigit(
                                items[index].open, NumStrLanguage.Farsi),
                          ),
                          textDirection: TextDirection.ltr,
                          style: TextStyle(fontSize: 11),
                          textAlign: TextAlign.center,
