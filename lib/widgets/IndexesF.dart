...
Future<List<IndexItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/indexes_f.json';
...
class IndexesF extends StatefulWidget {
  @override
  _IndexesFState createState() => _IndexesFState();
}

class _IndexesFState extends State<IndexesF> {
  @override
...
class ChechVersion extends StatelessWidget {
  ...
  ChechVersion({Key? key, required this.items}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Align(
