...
class _OtpFormState extends State<OtpForm> {
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    counterText: '',
                                    hintText: 'کد فعالسازی را وارد کنید'),
                                maxLength: 6,
                                style: TextStyle(),
  ...
  confirmOTP(
    ...
    final response = await client.post(
      Uri.parse('http://bourspardaz.ir/api/checkOTP.php'),
    ...
    if (response.statusCode == 200 && response.body.isNotEmpty) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: new Text("عملیات فعالسازی کاربر با موفقیت انجام شد."),
            actions: <Widget>[
              new TextButton(
                child: new Text("OK"),
                onPressed: () {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: new Text("خطا !!"),
            content: new Text("کد فعالسازی معتبر نیست."),
            actions: <Widget>[
              new TextButton(
                child: new Text("OK"),
                onPressed: () {
