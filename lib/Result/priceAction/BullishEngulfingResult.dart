...
Future<List<HammerItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/priceAction/daily/bullishEngulfing.json';
...
Future<List<HammerItems>> fetchWeeklyItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/priceAction/weekly/bullishEngulfing.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}
...
Future<List<HammerItems>> fetchMonthlyItems(Client client) async {
  String url =
      'https://bourspardaz.s3.ir-tbz-sh1.arvanstorage.com/priceAction/monthly/bullishEngulfing.json';
  final response = await client.get(Uri.parse(url));
  //return parseItems(response);
  return compute(parseItems, utf8.decode(response.bodyBytes));
}
...
class BullishEngulfingResult extends StatefulWidget {
  final String title;
  ...
  @override
  _BullishEngulfingResultState createState() => _BullishEngulfingResultState();
}

class _BullishEngulfingResultState extends State<BullishEngulfingResult> {
                        ...
                        onPressed: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => DescriptionActionPrice(
                              ...
                              patternTitle: 'الگوی پوشای صعودی',
