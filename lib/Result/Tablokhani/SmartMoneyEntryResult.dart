...
Future<List<MoneyItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/tablo/SmartMoneyEntry2.json';
...
class SmartMoneyEntryResult extends StatefulWidget {
  final String title;
 ...
 /*  final FlutterSecureStorage localStorageMobile;
  ...
  @override
  _SmartMoneyEntryResultState createState() => _SmartMoneyEntryResultState();
}

class _SmartMoneyEntryResultState extends State<SmartMoneyEntryResult> {
