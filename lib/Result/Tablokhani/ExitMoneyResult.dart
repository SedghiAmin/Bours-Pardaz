...
Future<List<MoneyItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/tablo/ExitMoney2.json';
...
class ExitMoneyResult extends StatefulWidget {
  final String title;
 ...
 /*  final FlutterSecureStorage localStorageMobile;
  ...
  @override
  _ExitMoneyResultState createState() => _ExitMoneyResultState();
}

class _ExitMoneyResultState extends State<ExitMoneyResult> {
