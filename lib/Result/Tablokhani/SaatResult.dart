...
Future<List<NavasanItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/tablo/Saat2.json';
...
class SaatResult extends StatefulWidget {
  final String title;
  ...
  @override
  _SaatResultState createState() => _SaatResultState();
}

class _SaatResultState extends State<SaatResult> {
  ...
  void onSort(int columnIndex, bool ascending) {
    if (columnIndex == 0) {
      ...
      widget.items.sort((row1, row2) => compareDouble(
          ascending, double.parse(row1.plp), double.parse(row2.plp)));
    } else if (columnIndex == 2) {
      widget.items.sort((row1, row2) => compareDouble(
          ascending, double.parse(row1.pcp), double.parse(row2.pcp)));
    }
