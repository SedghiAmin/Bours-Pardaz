...
Future<List<NavasanItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/tablo/LastPositive2.json';
...
class LastPositiveResult extends StatefulWidget {
  final String title;
  ...
  @override
  _LastPositiveResultState createState() => _LastPositiveResultState();
}

class _LastPositiveResultState extends State<LastPositiveResult> {
...
class _GenerateCardState extends State<GenerateCard> {
  ...
  void onSort(int columnIndex, bool ascending) {
    if (columnIndex == 0) {
      ...
      widget.items
          .sort((row1, row2) => compareString(ascending, row1.plp, row2.plp));
