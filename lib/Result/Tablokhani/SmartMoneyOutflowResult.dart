...
Future<List<MoneyItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/tablo/SmartMoneyOutflow2.json';
...
class SmartMoneyOutflowResult extends StatefulWidget {
  final String title;
...
/*   final FlutterSecureStorage localStorageMobile;
  ...
  @override
  _SmartMoneyOutflowResultState createState() =>
      _SmartMoneyOutflowResultState();
}

class _SmartMoneyOutflowResultState extends State<SmartMoneyOutflowResult> {
