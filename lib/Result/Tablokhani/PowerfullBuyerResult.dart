...
Future<List<MoneyItems>> fetchItems(Client client) async {
  String url =
      'https://s3.ir-thr-at1.arvanstorage.com/boursepardaz/vip/1/tablo/PowerfullBuyer2.json';
...
class PowerfullBuyerResult extends StatefulWidget {
  final String title;
...
/*   final FlutterSecureStorage localStorageMobile;
  ...
  @override
  _PowerfullBuyerResultState createState() => _PowerfullBuyerResultState();
}

class _PowerfullBuyerResultState extends State<PowerfullBuyerResult> {
  ...
  void onSort(int columnIndex, bool ascending) {
    if (columnIndex == 0) {
      ...
      widget.items.sort((row1, row2) => compareDouble(
          ascending, double.parse(row1.avgB), double.parse(row2.avgB)));
    } else if (columnIndex == 2) {
      widget.items.sort((row1, row2) => compareDouble(
          ascending,
          double.parse(row1.avgB) / double.parse(row1.avgS),
          double.parse(row2.avgB) / double.parse(row2.avgS)));
